...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LGUI, KC_LALT, RAISE,   LOWER,            KC_SPC,  KC_LSFT ,_______,        _______,KC_LGUI , KC_ENT,           KC_BSPC, KC_DEL, JP_UNDS,   ADJUST  \
  ),
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______  ,KC_UP, _______, _______, RGB_HUI,_LOWER,                       _LOWER, RGB_SAD,   KC_7, KC_8, KC_9, _______, _______, \
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______ , BL_DEC ,_QWERTY,                       _QWERTY, _______, KC_4, KC_5, KC_6, _______, _______, \
